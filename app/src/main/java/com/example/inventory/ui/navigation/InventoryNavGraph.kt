...
import com.example.inventory.ui.order.OrderAddDestination
import com.example.inventory.ui.order.OrderAddScreen
...
fun InventoryNavHost(navController: NavHostController) {
    NavHost(navController, startDestination = "inventory") {
        ...
        composable("orders") {
            OrdersScreen(navigateToItemEntry = { navController.navigate(OrderAddDestination.route) },) }
        composable(route = OrderAddDestination.route) {
            OrderAddScreen(
                navigateBack = { navController.popBackStack() },
                onNavigateUp = { navController.navigateUp() }
            )
